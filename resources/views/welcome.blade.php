        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function redrawRoute(userLat, userLng) {
                ...
                if (path.length > 1) {
                    ...
                    L.polyline(latlngs, { color: cheapestMode ? 'orange' : 'blue', weight: 4 }).addTo(map);
                    ...
                    ], { color: 'gray', weight: 4, dashArray: '6 6' }).addTo(map);
                    map.fitBounds([
                        [userLat, userLng],
                        [targetSeller.latitude, targetSeller.longitude]
                    ]);
                ...
                if (showStraight) {
                    ...
                    const straightDist = getDistance(userLat, userLng, targetSeller.latitude, targetSeller.longitude);
