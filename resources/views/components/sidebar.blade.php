    ...
    @if (Auth::guard('admin')->check())
        <ul class="nav-links">
            ...
            <li><a class="{{ Route::is('admin.mapadmin') ? 'active' : '' }}" href="{{ route('admin.mapadmin') }}"><i
                        class="fas fa-map-marker-alt"></i> Lokasi Penjual</a></li>
        </ul>
        ...
        <div class="sidebar-footer">
            ...
            <form action="{{ route('admin.logout') }}" method="POST" style="display:inline;">
                @csrf
                <button type="submit" class="logout-btn"><i class="fas fa-sign-out-alt"></i> Log
                    Out</button>
            </form>
        </div>
    @elseif(Auth::check())
        ...
        <div class="sidebar-footer">
            ...
            <form class="logout-form" action="{{ route('penjual.logout') }}" method="POST" style="display:inline;">
                @csrf
                <button type="submit" class="logout-btn"><i class="fas fa-sign-out-alt"></i> Log
                    Out</button>
            </form>
